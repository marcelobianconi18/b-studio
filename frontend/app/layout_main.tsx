    ...
    return (
        <div className="flex min-h-screen bg-[#050505] text-white font-sans selection:bg-blue-500/30">
            ...
            <main className="flex-1 ml-64 min-h-screen bg-[#050505]">
                ...
                {activeTab === "settings" && <div className="p-20 text-center text-zinc-500">Settings Module Coming Soon</div>}
            </main>
        </div>
    );
}
    ...
    return (
        <div className="p-10">
            <header className="mb-12">
                <h1 className="text-4xl font-black italic tracking-tighter mb-2">COMMAND CENTER</h1>
                <p className="text-zinc-500 text-sm">B-Studio Enterprise Overview</p>
            </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <h2 className="text-2xl font-bold mb-2 text-white">Traffic Manager</h2>
                        <p className="text-zinc-400 text-sm mb-6">Manage campaigns, monitor ROI, and scale winning ads using AI strategies.</p>

                        <div className="flex gap-4 text-[10px] font-mono text-zinc-500 uppercase tracking-widest">
                            <span className="bg-zinc-900 border border-zinc-800 px-3 py-1 rounded-full">ROAS Monitor</span>
                            <span className="bg-zinc-900 border border-zinc-800 px-3 py-1 rounded-full">Fatigue Alert</span>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <h2 className="text-2xl font-bold mb-2 text-white">Social Studio</h2>
                        <p className="text-zinc-400 text-sm mb-6">Analyze organic growth, manage inbox leads, and discover viral content.</p>

                        <div className="flex gap-4 text-[10px] font-mono text-zinc-500 uppercase tracking-widest">
                            <span className="bg-zinc-900 border border-zinc-800 px-3 py-1 rounded-full">Viral Alerts</span>
