            ...
            <div className="flex gap-4 mb-6 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-zinc-800">
                ...
                <div
                    ...
                    <div className="relative">
                        <div className={`w-2 h-2 rounded-full absolute top-0 right-0 ${status.meta_api === 'connected' ? 'bg-emerald-500 animate-pulse' : 'bg-red-500'}`} />
                    ...
                    {status.meta_api === 'connected' ? (
                        ...
                        <ExclamationTriangleIcon className="w-4 h-4 text-red-500 ml-auto" />
                    )}
                </div>
                ...
                <button
                    ...
                    <span className="text-zinc-400 font-medium group-hover:text-white transition-colors">TikTok Ads</span>
                    <ArrowPathIcon className="w-4 h-4 text-zinc-600 group-hover:text-white ml-auto" />
                </button>
                ...
                <div
                    ...
                    <div className="relative">
                        <div className={`w-2 h-2 rounded-full absolute top-0 right-0 ${status.ai_model === 'connected' ? 'bg-blue-500 animate-pulse' : 'bg-red-500'}`} />
