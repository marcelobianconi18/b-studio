            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center space-y-4">
                <div className="relative">
                    <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center">
                        <span className="text-2xl font-black text-[var(--foreground)]">{counts.hot}</span>
                    </div>
                    {counts.unread > 0 && (
                        <div className="absolute -top-1 -right-1 bg-zinc-900 text-[var(--foreground)] text-xs font-bold w-6 h-6 rounded-full flex items-center justify-center border-2 border-white">
                            {counts.unread}
                        </div>
                    )}
                </div>
                ...
                <div className="text-sm text-zinc-500">
                    <p className="font-medium text-[var(--foreground)]">{counts.hot} leads perguntando preço...</p>
                    <p className="text-xs mt-1">Última mensagem há 5 min.</p>
                </div>

                <button className="px-6 py-2 bg-white/10 hover:bg-white/10 text-[var(--foreground)] text-sm font-bold rounded-lg transition-colors w-full">
                    Responder Agora
                </button>
            </div>
        </div>
