    ...
    return (
        <div className="bg-zinc-900/30 border border-zinc-800 rounded-3xl p-6 h-full flex flex-col relative overflow-hidden">
            <h2 className="text-zinc-400 text-xs font-bold uppercase tracking-widest mb-4 flex items-center gap-2">
                <BoltIcon className="w-4 h-4 text-[var(--foreground)]" /> Centro de Ação (Aprovações)
            </h2>
                        ...
                        <div key={rec.id} className="bg-black/40 border border-zinc-800 p-4 rounded-xl flex justify-between items-start hover:border-zinc-700 transition-colors group">
                            <div>
                                <div className="flex items-center gap-2 mb-1">
                                    <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded ${rec.type === 'OPPORTUNITY' ? 'bg-white/10/50 text-[var(--foreground)]' : 'bg-white/10/50 text-[var(--foreground)]'}`}>
                                        {rec.type}
                                    </span>
                            ...
                            <div className="flex items-center gap-2 opacity-100 sm:opacity-0 group-hover:opacity-100 transition-opacity">
                                <button
                                    ...
                                    className="p-2 hover:bg-zinc-800 rounded-lg text-zinc-500 hover:text-[var(--foreground)] transition-colors"
                                    title="Dispensar"
                                >
                                ...
                                <button
                                    ...
                                    className="p-2 hover:bg-white/10/30 rounded-lg text-zinc-500 hover:text-[var(--foreground)] transition-colors"
